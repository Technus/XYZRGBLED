...
public class ColorConverter {
     ...
     */
    public static double[] RGBtoXYZ(javafx.scene.paint.Color color){
     ...
     * @return XYZ color space.
     */
    public static double[] RGBtoXYZ2(int red, int green, int blue,double mul){
        double[] xyz = new double[3];
    ...
    public static double[] RGBtoXYZ2(Color color, double mul) {
        return RGBtoXYZ2(color.getRed(),color.getGreen(),color.getBlue(),mul);
    }
    public static double[] RGBtoXYZ2(double r, double g, double b,double mul){
        double[] xyz = new double[3];
    ...
    public static double[] RGBtoXYZ2(javafx.scene.paint.Color color, double mul) {
        return RGBtoXYZ2(color.getRed(),color.getGreen(),color.getBlue(),mul);
    }
     ...
     * @return RGB color space.
     */
    public static javafx.scene.paint.Color XYZtoRGB2(double x, double y, double z, double div) {
